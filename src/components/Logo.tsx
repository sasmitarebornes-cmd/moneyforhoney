  ...
  return (
    ...
    >
      ...
      <div className="relative shrink-0 flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-linear-to-tr from-amber-500/25 via-yellow-400/20 to-emerald-400/25 rounded-2xl blur-lg -z-10 animate-pulse duration-1000" />
        <div className="absolute -inset-1 bg-linear-to-r from-amber-500/10 via-emerald-500/20 to-cyan-500/10 rounded-full blur-md -z-10 animate-ping opacity-25 duration-1000" />
      ...
      <div className="flex flex-col justify-center">
        <div className="flex items-center gap-2.5">
          <span
            className={`font-black tracking-wider uppercase bg-linear-to-r from-amber-300 via-yellow-100 to-amber-500 bg-clip-text text-transparent font-sans drop-shadow-sm ${dimensions.title}`}
          >
            MONEY For HONEY
          </span>
          ...
          <div
            className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-linear-to-r from-amber-500/15 via-yellow-500/20 to-amber-400/15 border border-amber-400/35 shadow-[0_0_12px_rgba(245,158,11,0.25)] group-hover:border-amber-400/60 transition-all duration-300"
          ...
          >
            ...
            <div className="relative w-6 h-6 flex items-center justify-center">
              ...
              >
                ...
                <path
                  d="M13.5 11.2 Q 13 17, 13.5 22.8"
                  stroke="#1F2937"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                />
                <path
                  d="M17.5 11.2 Q 17 17, 17.5 22.8"
                  stroke="#1F2937"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                />
        ...
        {showTagline && (
          <div className="flex items-center gap-1.5 mt-0.5">
            ...
            >
              autonomous Trading system and build self wealth engine for the
              future
            </span>
          </div>
        )}
